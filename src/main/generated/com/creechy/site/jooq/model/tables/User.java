...
import com.creechy.site.jooq.model.tables.IqCount.IqCountPath;
...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>creechy.user</code>
     */
    ...
    /**
     * The column <code>creechy.user.id</code>.
     */
    ...
    /**
     * The column <code>creechy.user.username</code>.
     */
    public final TableField<UserRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>creechy.user.hashed_password</code>.
     */
    public final TableField<UserRecord, String> HASHED_PASSWORD = createField(DSL.name("hashed_password"), SQLDataType.VARCHAR(255), this, "");
    ...
    /**
     * Create an aliased <code>creechy.user</code> table reference
     */
    ...
    /**
     * Create a <code>creechy.user</code> table reference
     */
    public User() {
    ...
    private transient IqCountPath _iqCount;

    /**
     * Get the implicit to-many join path to the <code>creechy.iq_count</code>
     * table
     */
    public IqCountPath iqCount() {
        if (_iqCount == null)
            _iqCount = new IqCountPath(this, null, Keys.FK_USERS.getInverseKey());
